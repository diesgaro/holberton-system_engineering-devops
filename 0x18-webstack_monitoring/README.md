...
* Create the answer file 2-setup_datadog which has the dashboard_id on the first line. Note: in order to get the id of your dashboard, you may need to use https://docs.datadoghq.com/api/v1/dashboards/#get-all-dashboards
